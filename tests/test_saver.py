...
class TestSaver:
    ...
    def test_save_to_file(self):
        """
        Checking that the file path exists and
        the save_to_file() function writes links to them
        :param data_valid_links: list (list with valid links)
        :param data_invalid_links: list (list with invalid links)
        :return: valid links are written to the "valid_links.txt" file,
        invalid links are written to the "broken_links.txt" file
        """
