...
class Interface:
    ...
    def run(self):
        ...
        while True:
            try:
                print('Choose what you want to parse: '
    ...
    def _add_html_args(self):
        ...
        while not is_valid_url(url):
            print("The entered link is invalid, "
    ...
    def _get_result(self, do_parse: Parser):
        ...
        save_to_file(*result)
        logger.info("All valid links are recorded "
                    "in the file 'valid_links.txt'")
        logger.info("Written all invalid links "
                    "in the file 'broken_links.txt'")
